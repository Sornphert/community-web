...
-- delete_my_account() is ABSENT on live MT (dropped out-of-band, never rewritten) and is
-- intentionally NOT created here — account deletion is non-functional on MT until a
-- multi-tenant rewrite lands (see memory/mt-app-group-breaks.md).
-- =============================================================================
