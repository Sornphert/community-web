...
export function CommentForm({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // Allow an image-only comment (a screenshot with no text).
    ...
    try {
      ...
      // Generate the id up front so images can be uploaded under the comment's
      // storage folder before the row is inserted (mirrors new-post-form).
